...
<!--
  ONERECORD CUSTOMIZATION BELOW
  Original:   table{border-spacing:0;border-collapse:collapse}
  New:        table{table-layout:fixed;word-wrap: break-word;border-spacing:0;border-collapse:collapse}
